#!/usr/bin/env python3
"""
Ablation 3: 验证知识探针的必要性
Main Model，但知识探针随机初始化（不使用外部知识文本编码）
"""
...
from src.single_stream_model_random_probes import SingleStreamClassifierRandomProbes
...
def main(args):
    print("="*80)
    print("Ablation 3: Main Model with Random Probes (No External Knowledge)")
    print("="*80)
    ...
    model = SingleStreamClassifierRandomProbes(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="output_ablation3_random_probes")
