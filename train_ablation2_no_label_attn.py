#!/usr/bin/env python3
"""
Ablation 2: 验证标签注意力机制的必要性
Main Model - 标签注意力 = 全局聚合(CLS) + 线性分类层
"""
...
def evaluate(model, data_loader, criterion, device, id2label, distance_matrix):
    ...
    with torch.no_grad():
        for batch in tqdm(data_loader, desc="Evaluating", leave=False):
            ...
            # SimpleClassifier使用input_ids作为参数名
...
def main(args):
    print("="*80)
    print("Ablation 2: Main Model - Label Attention (CLS + Linear)")
    print("="*80)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="output_ablation2_no_label_attn")
